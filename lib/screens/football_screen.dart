...
// Main Widget
class FootballTracker extends StatefulWidget {
  @override
  _FootballTrackerState createState() => _FootballTrackerState();
}

class _FootballTrackerState extends State<FootballTracker>
  ...
  void _initializeHabits() {
    habits = [
      Habit(title: 'Buts', value: '$_goals', icon: Icons.sports_soccer),
      Habit(title: 'Passes décisives', value: '$_assists', icon: Icons.assistant),
      Habit(title: 'Tirs cadrés', value: '$_shotsOnTarget', icon: Icons.center_focus_strong),
      Habit(title: 'Tirs non cadrés', value: '$_shotsOffTarget', icon: Icons.warning),
      Habit(title: 'Passes', value: '$_passes', icon: Icons.swap_horiz),
      Habit(title: 'Tacles', value: '$_tackles', icon: Icons.sports),
      Habit(title: 'Fautes', value: '$_fouls', icon: Icons.warning),
      Habit(title: 'Cartons jaunes', value: '$_yellowCards', icon: Icons.warning_amber),
      Habit(title: 'Cartons rouges', value: '$_redCards', icon: Icons.warning_amber),
    ];
  }
  ...
  void _incrementGoals() {
    setState(() {
      _goals++;
      habits[0] = Habit(title: 'Buts', value: '$_goals', icon: Icons.sports_soccer);
      _confettiController.play(); // Confettis pour chaque but
    });
  }
  ...
  void _incrementShotsOnTarget() {
    setState(() {
      _shotsOnTarget++;
      habits[2] = Habit(title: 'Tirs cadrés', value: '$_shotsOnTarget', icon: Icons.center_focus_strong);
    });
  }

  void _incrementShotsOffTarget() {
    setState(() {
      _shotsOffTarget++;
      habits[3] = Habit(title: 'Tirs non cadrés', value: '$_shotsOffTarget', icon: Icons.warning);
    });
  }

  void _incrementPasses() {
    setState(() {
      _passes++;
      habits[4] = Habit(title: 'Passes', value: '$_passes', icon: Icons.swap_horiz);
    });
  }

  void _incrementTackles() {
    setState(() {
      _tackles++;
      habits[5] = Habit(title: 'Tacles', value: '$_tackles', icon: Icons.sports);
    });
  }
  ...
  void _incrementFouls() {
    setState(() {
      _fouls++;
      habits[6] = Habit(title: 'Fautes', value: '$_fouls', icon: Icons.warning);
    });
  }

  void _incrementYellowCards() {
    setState(() {
      _yellowCards++;
      habits[7] = Habit(title: 'Cartons jaunes', value: '$_yellowCards', icon: Icons.warning_amber);
    });
  }

  void _incrementRedCards() {
    setState(() {
      _redCards++;
      habits[8] = Habit(title: 'Cartons rouges', value: '$_redCards', icon: Icons.warning_amber);
    });
  }
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSummaryRow(Icons.sports_soccer, 'Buts', '$_goals', Colors.purple),
                    _buildSummaryRow(Icons.assistant, 'Passes décisives', '$_assists', Colors.yellow),
                    _buildSummaryRow(Icons.center_focus_strong, 'Tirs cadrés', '$_shotsOnTarget', Colors.green),
                    _buildSummaryRow(Icons.warning, 'Tirs non cadrés', '$_shotsOffTarget', Colors.red),
                    _buildSummaryRow(Icons.swap_horiz, 'Passes', '$_passes', Colors.blue),
                    _buildSummaryRow(Icons.sports, 'Tacles', '$_tackles', Colors.teal),
                    _buildSummaryRow(Icons.warning, 'Fautes', '$_fouls', Colors.orange),
                    _buildSummaryRow(Icons.warning_amber, 'Cartons jaunes', '$_yellowCards', Colors.amber),
                    _buildSummaryRow(Icons.warning_amber, 'Cartons rouges', '$_redCards', Colors.red),
                  ],
                ),
              ),
            ),
      ...
      floatingActionButton: Column(
        ...
        children: [
          FloatingActionButton(
            ...
            child: Icon(Icons.sports_soccer, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
          FloatingActionButton(
          ...
          SizedBox(height: 16),
          FloatingActionButton(
            onPressed: _incrementShotsOnTarget,
            backgroundColor: Color(0xFF0C1A37),
            child: Icon(Icons.center_focus_strong, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
          FloatingActionButton(
            onPressed: _incrementShotsOffTarget,
            backgroundColor: Color(0xFF0C1A37),
            child: Icon(Icons.warning, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
          FloatingActionButton(
            onPressed: _incrementPasses,
            backgroundColor: Color(0xFF0C1A37),
            child: Icon(Icons.swap_horiz, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
          FloatingActionButton(
            onPressed: _incrementTackles,
            backgroundColor: Color(0xFF0C1A37),
            child: Icon(Icons.sports, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
          FloatingActionButton(
          ...
          SizedBox(height: 16),
          FloatingActionButton(
            onPressed: _incrementYellowCards,
            backgroundColor: Color(0xFF0C1A37),
            child: Icon(Icons.warning_amber, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
          FloatingActionButton(
            onPressed: _incrementRedCards,
            backgroundColor: Color(0xFF0C1A37),
            child: Icon(Icons.warning_amber, size: 30, color: Colors.white),
          ),
          SizedBox(height: 16),
  ...
  Widget _buildMainTitle() {
    return Padding(
      ...
      child: Text(
        'Suivi de votre match de football',
        style: GoogleFonts.bebasNeue(
          fontSize: 32,
  ...
  Widget _buildFootballIconSection() {
    return Container(
