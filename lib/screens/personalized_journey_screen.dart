...
class PersonalizedJourney extends StatefulWidget {
  const PersonalizedJourney({super.key});

  @override
  State<PersonalizedJourney> createState() => _PersonalizedJourneyState();
}

class _PersonalizedJourneyState extends State<PersonalizedJourney> with SingleTickerProviderStateMixin {
  final String quote = "Simplify your journey through our smart configurator.";
