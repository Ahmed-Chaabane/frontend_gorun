...
class _CyclingTrackerState extends State<CyclingTracker>
  ...
  void _initializeHabits() {
    habits = [
      Habit(title: 'Sessions', value: '$_sessions', icon: Icons.directions_bike),
      ...
      Habit(title: 'Heart Rate', value: '$_heartRate bpm', icon: Icons.favorite),
      Habit(title: 'Speed', value: '${_speed.toStringAsFixed(2)} km/h', icon: Icons.speed),
    ];
  }
  ...
  Widget _buildMainTitle() {
    return Padding(
      ...
      child: Text(
        'Suivi de votre séance de cyclisme',
        style: GoogleFonts.bebasNeue(
          fontSize: 32,
